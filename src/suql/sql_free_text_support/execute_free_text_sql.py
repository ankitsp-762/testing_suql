...
from postgresql_connection import execute_sql, execute_sql_with_column_info
from prompt_continuation import llm_generate
from utils import num_tokens_from_string
from free_text_fcns_server import _answer
...
def suql_execute(
    ...
    select_username="postgres",
    select_userpswd="12345",
